...
export function usePaginationActions({
  ...
  const handlePageChange = async (page: number) => {
    ...
    try {
      ...
      // ВАЖНО: Удаляем вызов handleSearch, так как мы хотим использовать клиентскую пагинацию
      // handleSearch здесь не нужен, так как у нас уже есть все данные в allSearchResults
      // и мы просто переключаем страницу локально
