  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-brand/30 to-brand/10">
      ...
      <main className="container mx-auto py-10 px-4">
        ...
        <SearchProvider>
          {/* Здесь SearchProvider нужен только для компонентов, которые используют useSearch */}
          <div style={{ display: 'none' }}>
            {/* Этот блок не будет виден, но обеспечит контекст для компонентов, 
                которые могут использоваться в других частях приложения */}
          </div>
        </SearchProvider>
