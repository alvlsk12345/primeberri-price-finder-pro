      ...
      <TooltipProvider>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button onClick={handlePrimeberriOrder} variant="brand-outline" className="flex items-center gap-2 w-full justify-center">
              <img src="/lovable-uploads/f3068d76-e0d6-47bb-9c0b-63b57087fd80.png" alt="Primeberri" className="h-5 w-5" />
              Заказать на Primeberri
            </Button>
          </TooltipTrigger>
          <TooltipContent>
            <p>Скопировать ссылку и перейти на сайт Primeberri</p>
          </TooltipContent>
        </Tooltip>
      </TooltipProvider>
    </div>;
