    ...
    const calculatePrice = async () => {
      try {
        ...
        if (parsedPrice > 200) {
          ...
          totalPriceInRubles = (parsedPrice + customsDuty + parsedPrice * customsFee) * exchangeRate + deliveryCost * exchangeRate;
        } else {
          // Formula for items 200 EUR or less
          // (price + price*0.05)*105 + 9.5*105
          totalPriceInRubles = (parsedPrice + parsedPrice * customsFee) * exchangeRate + deliveryCost * exchangeRate;
        }
